...
Speed & $.62\pm.01$ & $.65\pm.01$ & $.90\pm.01$ & $.89\pm.01$ & $.90\pm.00$ \\
...
\midrule
\multirow{4}{*}{Shadow}
& Static CP & $.691$ & 2.60 & $.307$ & $.168$ \\
& ACI & $\mathbf{.888}$ & 5.96 & $\mathbf{.072}$ & $.597$ \\
& Triggered ACI & $.843$ & 5.37 & $.121$ & $.539$ \\
& Weighted CP & $.690$ & 2.59 & $.308$ & $.167$ \\
\midrule
\multirow{4}{*}{Regime}
& Static CP & $.780$ & 2.60 & $.218$ & $.167$ \\
& ACI & $\mathbf{.892}$ & 4.49 & $\mathbf{.084}$ & $.416$ \\
& Triggered ACI & $.869$ & 4.21 & $.109$ & $.387$ \\
& Weighted CP & $.788$ & 2.70 & $.209$ & $.175$ \\
\bottomrule
\end{tabular}
\end{table}

Paired seed deltas confirm hard-shift reliability gains: ACI vs static is $+19.7$pp coverage on shadow shift (95\% CI $[19.2,20.1]$) and $+11.2$pp on regime switch (95\% CI $[10.3,12.4]$). Triggered ACI keeps most of that gain ($+15.2$pp shadow, $+8.9$pp regime) while reducing overhead versus full ACI by $5.85$pp and $2.88$pp, respectively.
...
Top-3 & $.627$ & 3.00 \\
Static CP & $.764$ & 4.75 \\
ACI & $\mathbf{.884}$ & 15.65 \\
Weighted CP & $.742$ & 4.40 \\
\bottomrule
\end{tabular}
\end{table}
