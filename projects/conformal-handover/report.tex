...
A coverage-overhead Pareto view in Appendix Fig.~\ref{fig:hard-shift-pareto} shows triggered ACI and DACI both lie on the frontier for hard shifts, while static and weighted CP dominate low-overhead points.
